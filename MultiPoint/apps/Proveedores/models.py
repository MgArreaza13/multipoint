...
class tb_proveedor (models.Model):
	...
	razonSocial					=	models.CharField(default='', null=True, max_length=30)
	cuit						=	models.IntegerField(default='', null=True)
	nameProveedor				=	models.CharField(default='', null=True, max_length=30)
	phoneNumberProveedor		=	models.CharField(default='', null=True, max_length=30)
	phoneNumberProveedorTwo		=	models.CharField(default='', null=True, max_length=30)
	addressProveedor 			=	models.TextField(default='', null=True)
	email 						= 	models.EmailField(default='', null=True, max_length=30)
